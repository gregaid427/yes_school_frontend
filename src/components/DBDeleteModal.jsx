...
import { deleteDBAction } from '../redux/slices/usersSlice';
import { useDispatch } from 'react-redux';

const DBDeleteModal = (props) => {
  console.log(props);
          ...
          <div style={{ display: display == 1 ? 'block' : 'none' }}>
            <div className="w-full mb-4 sm:w-2/2">
              <label
                ...
                htmlFor=""
              >
                Deleting Database will Remove db entirely from System & action
                cannot be undone
              </label>
            </div>
            <div className="w-full mb-4 sm:w-2/2">
