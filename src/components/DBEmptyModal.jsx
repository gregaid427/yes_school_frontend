...
import { emptyDBAction } from '../redux/slices/usersSlice';

const DBEmptyModal = (props) => {
  console.log(props);
          ...
          <div style={{ display: display == 1 ? 'block' : 'none' }}>
            <div className="w-full mb-4 sm:w-2/2">
              <label
                ...
                htmlFor=""
              >
                Emptying Database will clear records entirely from db & action
                cannot be undone
              </label>
            </div>
            <div className="w-full mb-4 sm:w-2/2">
