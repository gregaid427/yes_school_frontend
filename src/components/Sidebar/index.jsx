        ...
        <nav className="    lg:px-4">
          ...
          <div>
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/academics' || pathname.includes('academics')
                }
              >
                {(handleClick, open) => {
                  return (
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/fees' || pathname.includes('fees')
                }
              >
                {(handleClick, open) => {
                  return (
