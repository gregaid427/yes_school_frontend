...
import { CreateExamRemarksAction, GetExamRemarksAction, resetExamCart, UpdateExamCartegoryAction } from '../redux/slices/examSlice';

const ExamremarksModal = (props) => {
 ...
 if (name == '') {
    ...
    dispatch(CreateExamRemarksAction(data));
