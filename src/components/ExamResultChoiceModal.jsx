...
const ExamResultChoiceModal = (props) => {
  console.log(props);
  ...
  const { createexam,FetchexamSubject } = exam;
                        ...
                        if (sessionz == 'None') {
                          ...
                          dispatch(
                            FetchexamSubjectAction({
                              examgroup: examgroupoption,
                              session: sessionz,
                              class: props.value.title,
                              section:
                                props.value.section == null
                                  ? '-'
                                  : props.value.section,
                            }),
                          );
...
export default ExamResultChoiceModal;
