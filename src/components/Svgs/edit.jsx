...
const EditSVG = (props) => {
  return (
    <button  className='rounded-full bg-[#3C50E0] text-xs mx-0 my-1 font-bold  py-1 px-3' onClick={props.clickFunction}>
        {/* <svg className="fill-current" width="18" height="18" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
