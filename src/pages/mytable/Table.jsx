  ...
  return (
    <>
      <div className={'flex flex-col ' + tableWidth}>
        <div
          className={
            'rounded-sm border border-stroke bg-white px-5 pt-6 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 pb-6 '
          }
        >
          <div className="max-w-full overflow-x-auto">
            <div className="w-full  flex justify-between ">
              <div className="w-8/12 flex gap-3">{sideComponent}</div>

              <div
                className={
                  ' w-4/12 flex flex-col float-right ' +
                  (hideSearchInput ? 'hidden ' : '  ')
                }
              >
                <label
                    ...
                    return (
                      <>
                        <th
                          ...
                          className=" py-2 px-2 capitalize font-medium text-black dark:text-white "
                        >
                          {column.columnTitle}
                        </th>
                      </>
