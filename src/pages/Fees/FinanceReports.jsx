...
const FinanceReports = () => {
  ...
  const {  fetchRepoert } = fee;


  useEffect(() => {
        dispatch(fetchActivesessionAction());
    
    dispatch(fetchRepoert1Action({date: date }));
  ...
  useEffect(() => {
    if (fetchRepoert?.success == 1) {
      let data = fetchRepoert?.data;
      setdata(data);
    }
...
// console.log(clazz)
  ...
  function handleGetClassData() {
    ...
    dispatch(fetchRepoertAction(data));
  }
  const footerContent = (
    <div>
      <button
            ...
            <div className="w-full  flex justify-between ">
              <div className="  w-full flex flex-col gap-3 ">
                <div className="flex gap-3">
                  ...
                  <div className=" w-full ">
                    <div>
                      ...
                      <div className="relative z-20 bg-white dark:bg-form-input">
                      <FeeCartSelect2 setsectionprop={setfeecart} selectinfo={setSelectedInfo1}/>
                  ...
                  <div className="w-full ">
                    ...
                    <div className="relative z-20 bg-white dark:bg-form-input">
                    <StaffSelect setsectionprop={setstaff} selectinfo={setSelectedInfo}/>
                    </div>
                  </div>
                  <div className="w-full ">
                    <label
                ...
                <div className={"flex w-full gap-3"} >
                  <div className="flex gap-2 w-5/12">
