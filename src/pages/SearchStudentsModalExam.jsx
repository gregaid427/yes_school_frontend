...
import { FetchStdtPerformanceAction, resetFetchStdtPerformance } from '../redux/slices/examSlice';
import SingleTrack from './exam/SingleTrack';

const SearchStudentsModalExam = (props) => {
  ///////////////////////////////////
 ...
 const exam = useSelector((state) => state?.exam);
   const { examgroup, createxamgroup, UpdateExamCartegory,FetchStdtPerformance } = exam;
...
`,
     ...
     `,
      ...
      Table: `
  --data-table-library_grid-template-columns:  20% 50% 20% 10% ;
`,
    },
  ]);
  ...
  useEffect(() => {
    ...
    if (FetchStdtPerformance?.success == 1) {
      let data = FetchStdtPerformance?.data;
      setval(data)
  //
  setVisible9(true)
        // navigate("/settings/singletrack"  ,   {
        //   state: { info: info, value: data},} )
          dispatch(resetFetchStdtPerformance())

    }
  }, [FetchStdtPerformance]);
  ...
  return (
    <>
      ...
      >
        <SingleTrack close={setVisible9} info={info} value={value} />
      </Dialog>
      ...
      <div
        ...
        > 
          ...
          <div
            className={false ? 'hidden' : 'flex gap-3 mt-5  flex-col'}
          >
            <div>
              <Table
                data={data}
                            ...
                            <Cell>
                              ...
                              /> */}
                                ...
                                <TableBtn
                                  clickFunction={() => {
                                    setinfo(item);
                                    dispatch(FetchStdtPerformanceAction({'id':item.student_id}))
                                   // setVisible9(true);
                                  }}
                                  text={' Select '}
                                  color={'bg-primary'}
...
export default SearchStudentsModalExam;
