...
import StudentCartegoryItem from '../../components/StudentCartegoryItem';
import {
...
const StudentsCartegory = () => {
  ...
  const { fetchstdCartegory } = student;
  ...
  useEffect(() => {
    ...
    if (fetchstdCartegory?.success == 1) {
      let data = fetchstdCartegory?.data;
      setdata(data);
      setVisible1(false);
      setVisible(false);
    }
...
`,
  ...
  const handledeletebtn = () => {
    ...
    dispatch(deleteSingleStdCartAction(data));
  };
    ...
    <DefaultLayout>
      ...
      <div className={'flex gap-2  w-full'}>
        <div className="w-4/12">
          <StudentCartegoryItem close={setClasss} />
        </div>
...
export default StudentsCartegory;
