...
const rows = [
  { id: 1, session: '1st Term 2021', status: true  },
  { id: 2, session: '2nd Term 2021', status: false  },
  { id: 3, session: '1ST TERM 2023',  status: false },
...
const columns = [
  { columnTitle: 'id' },
  { columnTitle: 'session' },
  { columnTitle: 'status', format: (value) => (value == true ? <ActiveButton /> : ' ') },
