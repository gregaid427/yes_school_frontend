...
const FeeGenerateRecordList = (props) => {
  ...
  const { FetchGeneratefee } = fee;

  useEffect(() => {

    if (FetchGeneratefee?.success == 1) {
      let data = FetchGeneratefee?.data;
      setdata(data);
    }
  }, [FetchGeneratefee]);
                  ...
                  <>
                    <Body className="dark:border-strokedark dark:bg-boxdark  text-black  border-stroke bg-white dark:text-white flex dark:hover:bg-black hover:bg-[#EFF4FB] ">
                      ...
                      key={1} className="dark:border-strokedark Uppercase dark:bg-boxdark font-medium text-lg text-black  border-stroke bg-white dark:text-white flex ">
                        ...
                        <Cell className="  ">Session Generated</Cell>

                        <Cell>
                          <div className="gap-2 flex">Generated For</div>
                        </Cell>
                        <Cell>
                          <div className="gap-2 flex">Description</div>
                        </Cell>
                      </Row>
                      ...
                      {tableList?.map((item,index) => (
                        <>
                          ...
                          >
                            ...
                            <Cell className="  "> 
                              <span>{item?.entity == 'Class(es)' ?   <TableBtn
                                clickFunction={() => {
                                  setVisible9(true)
                                  setinfo(item.description.split(','))
...
export default FeeGenerateRecordList;
