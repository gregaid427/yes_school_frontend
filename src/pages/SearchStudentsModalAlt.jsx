...
const SearchStudentsModalAlt = (props) => {
  ///////////////////////////////////
...
`,
     ...
     `,
      ...
      Table: `
  --data-table-library_grid-template-columns:  15% 40% 15%  10% 10% 10%;
`,
    },
  ]);
  ...
  return (
    <>
      ...
      >
        <UpdateStudentAccountModal close={setVisible9} info={info} />
      </Dialog>
      ...
      <div className=" flex-col rounded-sm border max-w-full shadow-default border-stroke bg-white  dark:border-strokedark dark:dark:bg-form-input pb-5 ">
        ...
        >
          ...
          <div className=" bg-white  dark:border-strokedark dark:dark:bg-form-input">
            <button
              className="flex w-6/12 mx-auto justify-center border dark:border-strokedark rounded py-2 px-6 font-medium text-black  dark:text-white"
              type=""
              onClick={(e) => {
                e.preventDefault();
                props.close(false);
...
export default SearchStudentsModalAlt;
